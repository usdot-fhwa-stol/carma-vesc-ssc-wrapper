...
LABEL org.label-schema.name="carma-vesc-ssc-wrapper"
LABEL org.label-schema.description="VESC ssc interface wrapper for the CARMA Platform"
LABEL org.label-schema.vendor="Leidos"
LABEL org.label-schema.version=${VERSION}
LABEL org.label-schema.url="https://highways.dot.gov/research/research-programs/operations/CARMA"
LABEL org.label-schema.vcs-url="https://github.com/usdot-fhwa-stol/carma-vesc-ssc-wrapper/"
...
CMD [ "wait-for-it.sh", "localhost:11311", "--", "roslaunch", "carma_vesc_ssc_wrapper", "carma_vesc_ssc_wrapper.launch"]
