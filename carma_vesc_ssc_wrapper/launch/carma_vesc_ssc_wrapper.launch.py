...
DRIVER_PARAM_FILE = os.path.join(
  get_package_share_directory('carma_vesc_ssc_wrapper'), 'config', 'vesc_driver.params.yaml')

WRAPPER_PARAM_FILE = os.path.join(
  get_package_share_directory('carma_vesc_ssc_wrapper'), 'config', 'vesc_wrapper.params.yaml')
...
def generate_launch_description():
  ...
  wrapper_node = Node(
          name='carma_vesc_ssc_wrapper',
          package='carma_vesc_ssc_wrapper',
  ...
  wrapper_composable_node = ComposableNodeContainer(
          name='carma_vesc_ssc_wrapper_container',
          ...
          composable_node_descriptions=[
              ComposableNode(
                  name='carma_vesc_ssc_wrapper',
                  package='carma_vesc_ssc_wrapper',
                  plugin='carma_vesc_ssc_wrapper::ComposableNode',
                  parameters=[WRAPPER_PARAM_FILE],
