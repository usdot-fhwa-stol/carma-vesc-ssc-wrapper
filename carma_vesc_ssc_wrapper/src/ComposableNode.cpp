...
#include "carma_vesc_ssc_wrapper/ComposableNode.hpp"

using std_msec = std::chrono::milliseconds;

namespace carma_vesc_ssc_wrapper
{   
...
RCLCPP_COMPONENTS_REGISTER_NODE(carma_vesc_ssc_wrapper::ComposableNode)