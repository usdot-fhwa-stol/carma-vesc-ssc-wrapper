...
if [ $build_ros1_pkgs -eq 1 ]; then
    ...
    colcon build --packages-up-to carma_vesc_ssc_wrapper pacmod3 kvaser_interface --build-base ./build_carma_vesc_ssc_wrapper --install-base /opt/carma/install_ros2 --cmake-args -DCMAKE_BUILD_TYPE=Release
